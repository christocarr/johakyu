export default function About() {
	return (
		<main className="font-roboto flex flex-col flex-grow p-5 pt-0 sm:w-2/3 sm:mx-auto sm:mt-5 lg:w-2/4 xl:w-2/5">
			<h1 className="text-xl font-jura text-brand-red font-bold sm:ml-10">About Us</h1>
			<div className="flex mt-5">
				<h2 className="hidden w-8 text-brand-red font-semibold sm:mr-5 sm:flex sm:flex-col-rev">アバウト</h2>
				<div >
